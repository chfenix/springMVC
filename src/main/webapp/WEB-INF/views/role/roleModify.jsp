		...
		<!-- 正文区域 -->
			...
			<!-- 上方提示框 -->
			    <div class="box box-info">
			        ...
			        <div class="box-body">
			            <form action="modifyRole.do" method="post" onsubmit="return epJudge();" id="role_form" name="role_form" class="form-horizontal bv-form" novalidate="novalidate">
			            	<!-- 隐藏域 -->
			                    ...
			                    <div class="row">
			                        <div class="col-md-6">
			                            ...
			                            <div class="form-group has-feedback">
			                                ...
			                                <div class="col-sm-8">
			                                    <tags:select selectId="status" selectName="status" typeCode="COMMON_VALID" selectValue="${sr.status}" selectStyle="width: 100%;height: 34px;padding: 6px 12px;border: 1px solid #d2d6de;"></tags:select>
			                                </div>
			                            </div>
			                        </div>
...
function epJudge(){
	...
	//如果没有操作，则提示，并停留在当前页
	if(name=='${sr.name}'&&code=="${sr.code}"&&$("#status").val()=="${sr.status}"){
		if($("#funcs").val()=='${funcs}'){
